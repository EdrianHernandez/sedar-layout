  ...
  return <section className="profile-header-card">
    <div className="profile-header-main">
      ...
      <div className="profile-header-actions">
        <button className="button button-primary" type="button" onClick={() => navigate(`/marketing/service-requests/new?customerId=${customer.id}`)}><Plus size={15} />New Service Request</button>
