...
export const CONTRACT_STATUSES: readonly ContractStatus[] = ['Requested', 'Drafting', 'Internal Review', 'Approved for Signature', 'Sent for Signature', 'Partially Signed', 'Fully Executed', 'Active', 'Suspended', 'Terminated', 'Expired', 'Draft', 'For Internal Review', 'Ready for Signature', 'Awaiting Signatures', 'Superseded']
export const SIGNATURE_STATUSES: readonly SignatureStatus[] = ['Not Ready for Signature', 'Awaiting SEDAR Signature', 'Awaiting Customer Signature', 'Partially Signed', 'Fully Signed', 'Not Started', 'SEDAR Signed', 'Customer Signed', 'Fully Executed', 'Declined']
