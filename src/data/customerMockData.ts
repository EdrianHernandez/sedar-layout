...
export const initialCustomers: Customer[] = [
  {
    ...
    customerType: 'Shipping Company', activeRequests: 3, activeContracts: 2, lastInteraction: '2026-08-02', status: 'Active', assignedRepresentative: 'Andrea Santos', needsFollowUp: false,
  ...
  },
  {
    ...
    customerType: 'Vessel Owner', activeRequests: 2, activeContracts: 1, lastInteraction: '2026-07-28', status: 'Active', assignedRepresentative: 'Andrea Santos', needsFollowUp: true,
  },
  {
    ...
    customerType: 'Port Operator', activeRequests: 0, activeContracts: 1, lastInteraction: '2026-07-21', status: 'Inactive', assignedRepresentative: 'Bianca Flores', needsFollowUp: false,
  },
  {
    ...
    customerType: 'Shipping Company', activeRequests: 5, activeContracts: 3, lastInteraction: '2026-08-01', status: 'Active', assignedRepresentative: 'Miguel Reyes', needsFollowUp: false,
  },
  {
    ...
    customerType: 'Vessel Owner', activeRequests: 0, activeContracts: 0, lastInteraction: '2026-07-18', status: 'Prospect', assignedRepresentative: 'Bianca Flores', needsFollowUp: true,
  },
  {
  ...
  },
  {
    ...
    customerType: 'Government Agency', activeRequests: 2, activeContracts: 2, lastInteraction: '2026-07-31', status: 'Active', assignedRepresentative: 'Miguel Reyes', needsFollowUp: false,
  },
]
